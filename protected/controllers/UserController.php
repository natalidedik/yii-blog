...
class UserController extends Controller {
    ...
    public function accessRules() {
        return array(
            array('allow', // allow all to perform 'index' and 'view' actions
                'actions' => array('register', 'index'),
                'users' => array('*'),
            ),
...
//        if (isset($_POST['User']['role']) && !Yii::app()->user->checkAccess('admin')) {
//            throw new CHttpException(403, 'Forbidden');
//        }
//проверяем, может ли пользователь изменять данную запись
//        if (!Yii::app()->user->checkAccess('admin') && !Yii::app()->user->checkAccess('updateOwnData', array('user' => $model))) {
//            throw new CHttpException(403, 'Forbidden');
//        }
